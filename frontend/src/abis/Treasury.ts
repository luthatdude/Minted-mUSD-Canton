...
export const TREASURY_ABI = [
  ...
  "function pendingYield() view returns (uint256 netYield, uint256 grossYield, uint256 protocolFee)",
  "function peakRecordedValue() view returns (uint256)",
  "function lastRecordedValue() view returns (uint256)",
  ...
  "function accrueFees()",
  "function claimFees()",
  "function harvestYield() returns (uint256 claimedFees)",
