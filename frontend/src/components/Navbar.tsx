        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="hidden items-center gap-1 lg:flex">
              {NAV_ITEMS.map((item) => {
                ...
                const activeColor = chain === "ethereum" ? "text-brand-400" : "text-amber-400";
                const activeBg = chain === "ethereum" ? "bg-brand-500/10" : "bg-amber-500/10";
                    ...
                    {isActive && (
                      <span 
                        className={`absolute bottom-0 left-1/2 h-0.5 w-8 -translate-x-1/2 rounded-full ${
                          chain === "ethereum" ? "bg-brand-500" : "bg-amber-500"
                        }`} 
                      />
                    )}
                  </button>
          ...
          <div className="flex items-center gap-3">
            ...
            {chain === "ethereum" ? (
              ...
              cantonParty ? (
                <div className="flex items-center gap-2 rounded-xl border border-amber-500/30 bg-amber-500/10 px-4 py-2.5 backdrop-blur-sm">
