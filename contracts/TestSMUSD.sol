...
contract TestSMUSD is ERC4626, AccessControl, ReentrancyGuard, Pausable, GlobalPausable {
    ...
    uint256 public constant WITHDRAW_COOLDOWN = 60; // 60 seconds for testnet
    ...
    constructor(IERC20 _musd, address _globalPauseRegistry) ERC4626(_musd) ERC20("Staked mUSD (Test)", "smUSD") GlobalPausable(_globalPauseRegistry) {
