...
contract DirectMintV2 is AccessControl, ReentrancyGuard, Pausable, TimelockGoverned {
 ...
 // Withdraw full usdcEquivalent from Treasury, keep fee here.
 ...
 /// Include min-fee-of-1 logic to match actual redeem() behavior
 ...
 // Match redeem() min-fee logic — if fee BPS > 0 but rounds to 0, charge 1 wei
 ...
 /// @notice Withdraw accumulated redeem fees (now held in this contract)
 ...
 /// Unpause requires admin, not pauser (separation of duties)
 ...
 // Also block mUSD recovery to prevent extraction of protocol tokens
