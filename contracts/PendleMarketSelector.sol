 ...
 */
 ...
 // Safe int128→uint128 cast — clamp negatives to 0
 uint256 ptValueInSy = (
 ...
 */
 ...
 /// Cap whitelistedMarkets array to prevent gas DoS
 ...
 */
 ...
 // Cap batch size to prevent out-of-gas on large arrays
 require(markets.length <= 50, "BATCH_TOO_LARGE");

 for (uint256 i = 0; i < markets.length; i++) {
 // Validate non-zero address in batch path (matches single whitelist)
