...
contract DirectMintV2 is AccessControl, ReentrancyGuard, Pausable {
    ...
    function mint(uint256 usdcAmount) external nonReentrant whenNotPaused returns (uint256 musdOut) {
        ...
        uint256 feeUsdc = (usdcAmount * mintFeeBps) / 10000;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000001,feeUsdc)}
        uint256 usdcAfterFee = usdcAmount - feeUsdc;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000002,usdcAfterFee)}

        // Convert USDC (6 decimals) to mUSD (18 decimals)
        musdOut = usdcAfterFee * 1e12;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000e,musdOut)}
    ...
    function redeem(uint256 musdAmount) external nonReentrant whenNotPaused returns (uint256 usdcOut) {
        ...
        uint256 usdcEquivalent = musdAmount / 1e12;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000003,usdcEquivalent)}
        ...
        uint256 feeUsdc = (musdAmount * redeemFeeBps) / (1e12 * 10000);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000004,feeUsdc)}
        ...
        usdcOut = usdcEquivalent - feeUsdc;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000f,usdcOut)}
    ...
    function mintFor(address recipient, uint256 usdcAmount) external nonReentrant whenNotPaused onlyRole(MINTER_ROLE) returns (uint256 musdOut) {
        ...
        // Calculate fee in USDC terms
        uint256 feeUsdc = (usdcAmount * mintFeeBps) / 10000;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000005,feeUsdc)}
        uint256 usdcAfterFee = usdcAmount - feeUsdc;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000006,usdcAfterFee)}

        // Convert USDC (6 decimals) to mUSD (18 decimals)
        musdOut = usdcAfterFee * 1e12;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000010,musdOut)}
    ...
    function previewMint(uint256 usdcAmount) external view returns (uint256 musdOut, uint256 feeUsdc) {
        feeUsdc = (usdcAmount * mintFeeBps) / 10000;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000011,feeUsdc)}
        uint256 usdcAfterFee = usdcAmount - feeUsdc;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000007,usdcAfterFee)}
        musdOut = usdcAfterFee * 1e12;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000012,musdOut)}
    }
    ...
    function previewRedeem(uint256 musdAmount) external view returns (uint256 usdcOut, uint256 feeUsdc) {
        uint256 usdcEquivalent = musdAmount / 1e12;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000008,usdcEquivalent)}
        // Combined calculation to avoid precision loss
        feeUsdc = (musdAmount * redeemFeeBps) / (1e12 * 10000);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000013,feeUsdc)}
        // Apply the same fee floor as redeem()
        if (redeemFeeBps > 0 && feeUsdc == 0) {
            feeUsdc = 1; // Minimum 1 wei USDC fee — matches redeem()
        }
        usdcOut = usdcEquivalent - feeUsdc;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000014,usdcOut)}
    }

    /// @notice Check how much more mUSD can be minted
    function remainingMintable() external view returns (uint256) {
        uint256 cap = musd.supplyCap();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000009,cap)}
        uint256 supply = musd.totalSupply();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000a,supply)}
    ...
    function setFeeRecipient(address _recipient) external onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        address old = feeRecipient;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000b,old)}
    ...
    function withdrawFees() external onlyRole(FEE_MANAGER_ROLE) {
        uint256 fees = mintFees;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000c,fees)}
    ...
    function withdrawRedeemFees() external onlyRole(FEE_MANAGER_ROLE) {
        uint256 fees = redeemFees;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000d,fees)}
