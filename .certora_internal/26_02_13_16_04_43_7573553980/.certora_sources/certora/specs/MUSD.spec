...
///      Sload hook constrains initial state so no individual balance exceeds sum.
...
///      OZ ERC20._balances. Sload hook constrains initial state.
///      The invariant proves that mint/burn/transfer preserve the
///      fundamental ERC20 accounting identity.
