...
contract LiquidationEngine is AccessControl, ReentrancyGuard, Pausable {
    ...
    function liquidate(
        ...
        uint256 hf = borrowModule.healthFactorUnsafe(borrower);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000001,hf)}
        if (hf >= 10000) revert PositionHealthy();

        uint256 actualRepay;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000002,actualRepay)}
        uint256 seizeAmount;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000003,seizeAmount)}
        (actualRepay, seizeAmount) = _calculateLiquidation(borrower, collateralToken, debtToRepay, hf);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020010,0)}
    ...
    function _calculateLiquidation(
        ...
        uint256 debtToRepay,
        uint256 hf
    ) internal returns (uint256 actualRepay, uint256 seizeAmount) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00000000, 1037618708480) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00000001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00000005, 585) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00006003, hf) }
        uint256 totalDebt = borrowModule.totalDebt(borrower);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000004,totalDebt)}
        uint256 maxRepay = hf < fullLiquidationThreshold ? totalDebt : (totalDebt * closeFactorBps) / 10000;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000005,maxRepay)}
        actualRepay = debtToRepay > maxRepay ? maxRepay : debtToRepay;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000011,actualRepay)}

        (, , , uint256 penaltyBps) = vault.getConfig(collateralToken);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010006,0)}
        uint256 collateralPrice = oracle.getPriceUnsafe(collateralToken);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000007,collateralPrice)}
        if (collateralPrice == 0) revert InvalidPrice();

        seizeAmount = (actualRepay * (10000 + penaltyBps) * (10 ** IERC20Decimals(collateralToken).decimals())) / (10000 * collateralPrice);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000012,seizeAmount)}
        ...
        );assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020013,0)}
    }
    ...
    function _capSeizureAndTrackBadDebt(
        ...
        uint256 seizeAmount,
        uint256 penaltyBps
    ) internal returns (uint256, uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00010000, 1037618708481) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00010001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00010005, 4681) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00016004, penaltyBps) }
        uint256 available = vault.deposits(borrower, collateralToken);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000008,available)}
    ...
    function isLiquidatable(address borrower) external view returns (bool) {
        uint256 debt = borrowModule.totalDebt(borrower);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000009,debt)}
    ...
    function estimateSeize(
        ...
        (, , , uint256 penaltyBps) = vault.getConfig(collateralToken);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001000a,0)}

        // Use unsafe version so estimates work even when circuit breaker trips
        uint256 collateralPrice = oracle.getPriceUnsafe(collateralToken);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000b,collateralPrice)}
        if (collateralPrice == 0) return 0;

        // Combined calculation avoids divide-before-multiply precision loss
        uint8 tokenDecimals = IERC20Decimals(collateralToken).decimals();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000c,tokenDecimals)}
        collateralAmount = (debtToRepay * (10000 + penaltyBps) * (10 ** tokenDecimals)) / (10000 * collateralPrice);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000014,collateralAmount)}

        uint256 available = vault.deposits(borrower, collateralToken);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000d,available)}
    ...
    function setCloseFactor(uint256 _bps) external onlyRole(TIMELOCK_ROLE) {
        ...
        uint256 old = closeFactorBps;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000e,old)}
        closeFactorBps = _bps;
    ...
    function socializeBadDebt(address borrower) external onlyRole(ENGINE_ADMIN_ROLE) {
        uint256 amount = borrowerBadDebt[borrower];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000f,amount)}
