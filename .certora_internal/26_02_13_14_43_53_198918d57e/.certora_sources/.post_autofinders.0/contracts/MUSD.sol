...
contract MUSD is ERC20, AccessControl, Pausable {
    ...
    function setSupplyCap(uint256 _cap) external {
        ...
        uint256 oldCap = supplyCap;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000001,oldCap)}
        uint256 currentSupply = totalSupply();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000002,currentSupply)}
    ...
    function mint(address to, uint256 amount) external onlyRole(BRIDGE_ROLE) {
        ...
        uint256 effectiveCap = (supplyCap * localCapBps) / 10000;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000003,effectiveCap)}
    ...
    function _update(address from, address to, uint256 value) internal override logInternal0(value)whenNotPaused {
        if (isBlacklisted[from] || isBlacklisted[to]) revert ComplianceReject();
        super._update(from, to, value);
    }modifier logInternal0(uint256 value) { assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00000000, 1037618708480) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00000001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00000005, 73) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00006002, value) } _; }
