...
methods {
    ...
    // MUSD (linked underlying token) — need explicit summaries
...
///      Preserved block constrains MUSD to be operational (not paused,
///      vault not blacklisted) — if MUSD is paused, no state change occurs.
