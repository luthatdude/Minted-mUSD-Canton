    ...
    TimelockGoverned
{
     ...
     */
    function totalValue() public view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000e0000, 1037618708494) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000e0001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000e0004, 0) }
        uint256 total = reserveBalance();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000006,total)}
     ...
     */
    function totalValueNet() public view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000a0000, 1037618708490) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000a0001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000a0004, 0) }
        uint256 total = totalValue();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000007,total)}
        uint256 pending = _calculatePendingFees();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000008,pending)}
     ...
     */
    function targetReserve() public view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00130000, 1037618708499) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00130001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00130004, 0) }
    ...
    function getCurrentAllocations() external view returns (
        ...
        uint256 total = totalValue();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000009,total)}
        uint256 len = strategies.length;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000a,len)}

        strategyAddresses = new address[](len);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002002a,0)}
        currentBps = new uint256[](len);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002002b,0)}
        _targetBps = new uint256[](len);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002002c,0)}

        for (uint256 i = 0; i < len; i++) {
            strategyAddresses[i] = strategies[i].strategy;address certora_local59 = strategyAddresses[i];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000003b,certora_local59)}
            _targetBps[i] = strategies[i].targetBps;uint256 certora_local60 = _targetBps[i];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000003c,certora_local60)}
     ...
     */
    function _calculatePendingFees() internal view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00030000, 1037618708483) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00030001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00030004, 0) }
        uint256 currentValue = totalValue();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000b,currentValue)}
        if (currentValue <= lastRecordedValue) return fees.accruedFees;

        uint256 yield_ = currentValue - lastRecordedValue;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000c,yield_)}
        uint256 newFees = (yield_ * fees.performanceFeeBps) / BPS;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000d,newFees)}
        ...
        returns (uint256[] memory allocations)
    {
        ...
        if (amount >= minAutoAllocateAmount) {
            ...
            allocations = new uint256[](strategies.length);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002003d,0)}
        }
        ...
        returns (uint256 actualAmount)
    {
        ...
        uint256 reserve = reserveBalance();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000e,reserve)}
        ...
        if (reserve >= amount) {
            ...
            uint256 needed = amount - reserve;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000002f,needed)}
            // slither-disable-next-line reentrancy-vulnerabilities
            uint256 withdrawn = _withdrawFromStrategies(needed);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000030,withdrawn)}

            actualAmount = reserve + withdrawn;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000003e,actualAmount)}
    ...
    function deposit(address from, uint256 amount) external nonReentrant whenNotPaused onlyRole(VAULT_ROLE) {
        ...
        uint256[] memory allocs = new uint256[](0);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001000f,0)}
    ...
    function withdraw(address to, uint256 amount) external nonReentrant whenNotPaused onlyRole(VAULT_ROLE) {
        ...
        uint256 reserve = reserveBalance();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000010,reserve)}
        if (reserve < amount) {
            uint256 needed = amount - reserve;
            _withdrawFromStrategies(needed);
        }

        uint256 available = reserveBalance();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000011,available)}
     ...
     */
    function _autoAllocate(uint256 amount) internal returns (uint256[] memory allocations) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00040000, 1037618708484) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00040001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00040005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00046000, amount) }
        allocations = new uint256[](strategies.length);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002002d,0)}

        // Calculate how much goes to reserve
        uint256 toReserve = (amount * reserveBps) / BPS;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000012,toReserve)}
        uint256 toAllocate = amount - toReserve;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000013,toAllocate)}

        // Calculate total target bps for active auto-allocate strategies
        uint256 totalTargetBps = 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000014,totalTargetBps)}
        for (uint256 i = 0; i < strategies.length; i++) {
        ...
        uint256 sharesApproved = 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000015,sharesApproved)}
        uint256 lastActiveIdx = type(uint256).max;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000016,lastActiveIdx)}
        ...
        for (uint256 i = 0; i < strategies.length; i++) {
            ...
            uint256 share;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000031,share)}
            if (i == lastActiveIdx) {
                // Last active strategy gets remainder to avoid rounding dust
                share = toAllocate - sharesApproved;
            } else {
                share = (toAllocate * strategies[i].targetBps) / totalTargetBps;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000003f,share)}
            }
     ...
     */
    function _withdrawFromStrategies(uint256 amount) internal returns (uint256 totalWithdrawn) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00060000, 1037618708486) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00060001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00060005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00066000, amount) }
        uint256 remaining = amount;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000017,remaining)}

        // Calculate total strategy value
        // Use try/catch to prevent DoS from reverting strategies
        uint256 totalStratValue = 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000018,totalStratValue)}
        uint256 lastActiveIdx = type(uint256).max;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000019,lastActiveIdx)}
        for (uint256 i = 0; i < strategies.length; i++) {
            if (strategies[i].active) {
                // slither-disable-next-line calls-loop
                try IStrategy(strategies[i].strategy).totalValue() returns (uint256 val) {
        ...
        for (uint256 i = 0; i < strategies.length && remaining > 0; i++) {
            ...
            address strat = strategies[i].strategy;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000032,strat)}
            // slither-disable-next-line calls-loop
            // Use try/catch for strategy value query
            uint256 stratValue = 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000033,stratValue)}
            ...
            uint256 toWithdraw;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000034,toWithdraw)}
            if (i == lastActiveIdx) {
                toWithdraw = remaining;
            } else {
                toWithdraw = (amount * stratValue) / totalStratValue;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000040,toWithdraw)}
            }
    ...
    function _accrueFees() internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00070000, 1037618708487) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00070001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00070004, 0) }
        if (block.timestamp < lastFeeAccrual + MIN_ACCRUAL_INTERVAL) {
            return;
        }

        uint256 currentValue = totalValue();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000001a,currentValue)}
        ...
        uint256 peak = peakRecordedValue > lastRecordedValue ? peakRecordedValue : lastRecordedValue;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000001b,peak)}
    ...
    function claimFees() external nonReentrant onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        uint256 toClaim = fees.accruedFees;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000001c,toClaim)}
        ...
        uint256 reserve = reserveBalance();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000001d,reserve)}
        if (reserve < toClaim) {
            _withdrawFromStrategies(toClaim - reserve);
        }

        uint256 available = reserveBalance();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000001e,available)}
        uint256 toSend = available < toClaim ? available : toClaim;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000001f,toSend)}
    ...
    function addStrategy(
        ...
        uint256 totalTarget = targetBps + reserveBps;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000020,totalTarget)}
        for (uint256 i = 0; i < strategies.length; i++) {
            if (strategies[i].active) {
    ...
    function removeStrategy(address strategy) external onlyRole(STRATEGIST_ROLE) {
        ...
        uint256 idx = strategyIndex[strategy];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000021,idx)}
    ...
    function updateStrategy(
        ...
        uint256 idx = strategyIndex[strategy];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000022,idx)}

        // Validate new allocation
        uint256 totalTarget = targetBps + reserveBps;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000023,totalTarget)}
        for (uint256 i = 0; i < strategies.length; i++) {
    ...
    function rebalance() external nonReentrant onlyRole(ALLOCATOR_ROLE) {
        ...
        uint256 total = totalValue();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000024,total)}
        // slither-disable-next-line incorrect-equality
        if (total == 0) return;
        ...
        for (uint256 i = 0; i < strategies.length; i++) {
            ...
            address strat = strategies[i].strategy;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000035,strat)}
            // slither-disable-next-line calls-loop
            uint256 currentValue = IStrategy(strat).totalValue();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000036,currentValue)}
            uint256 targetValue = (total * strategies[i].targetBps) / BPS;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000037,targetValue)}
        ...
        total = totalValue();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000002e,total)}

        // Second pass: deposit to under-allocated strategies
        uint256 reserve = reserveBalance();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000025,reserve)}
        uint256 targetReserveAmt = (total * reserveBps) / BPS;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000026,targetReserveAmt)}
        uint256 available = reserve > targetReserveAmt ? reserve - targetReserveAmt : 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000027,available)}

        for (uint256 i = 0; i < strategies.length && available > 0; i++) {
            if (!strategies[i].active) continue;

            address strat = strategies[i].strategy;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000038,strat)}
            // slither-disable-next-line calls-loop
            uint256 currentValue = IStrategy(strat).totalValue();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000039,currentValue)}
            uint256 targetValue = (total * strategies[i].targetBps) / BPS;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000003a,targetValue)}
    ...
    function setReserveBps(uint256 _reserveBps) external onlyTimelock {
        ...
        uint256 oldBps = reserveBps;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000028,oldBps)}
    ...
    function setMinAutoAllocate(uint256 _minAmount) external onlyTimelock {
        ...
        uint256 oldAmount = minAutoAllocateAmount;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000029,oldAmount)}
    ...
    function _authorizeUpgrade(address) internal override logInternal5()onlyTimelock {}modifier logInternal5() { assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00050000, 1037618708485) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00050001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00050004, 1) } _; }
}
